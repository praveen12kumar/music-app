...
import DashboardStats from "../../components/atoms/dashboardStats/DashboardStats";
import SongsTableAdmin from "../../components/organisms/songsTableAdmin/SongsTableAdmin";
import AlbumTableAdmin from "../../components/organisms/albumTableAdmin/AlbumTableAdmin";
...
function AdminPage() {
  ...
  const [toggleSongAlbum, setToggleSongAlbum] = useState<boolean>(true);
